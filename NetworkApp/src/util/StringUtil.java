...
//		확장자 구하기
	...
	/**
	 * 문자열에 해당 문자가 얼마나 있는지 반환하는 메서드
	 * @param c 비교할 기준이 되는 문자
	 * @param s 비교 대상이 될 문자열
	 * @return s문자열에 c라는 문자가 얼마나 있는지 정수형으로 반환
	 */
	
	public static int getCountOfChar(char c, String s) {
